...
This is a fork providing polish translations for keywords such as abstract, references, etc. It's not published, so you need to install it locally using typship.
