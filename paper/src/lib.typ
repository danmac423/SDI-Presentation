...
#let lncs(
  ...
  set text(font: "New Computer Modern", lang: "pl", size: 10pt)
  ...
  //// PAR CONFIG
  set par(leading: 0.50em, spacing: 0.5em)
  ...
  show math.equation: set block(above: 12pt, below: 12pt)
  show ref: it => {
